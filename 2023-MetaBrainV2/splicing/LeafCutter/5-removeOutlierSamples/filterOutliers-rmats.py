...
if len(sys.argv) < 5:
    print("Usage: pca-input-prefix z-score-cut-off psi-file-prefix output-dir")
    sys.exit(0)
...
for psiFile in psiFiles:
    ...
    fileName = fileName[:-3]
    print("writing:"+ outputDir +fileName+"-outliersRemoved.txt.gz")
    
    psiDfFiltered.to_csv(outputDir +fileName+"-outliersRemoved.txt.gz", sep='\t', na_rep="nan")
